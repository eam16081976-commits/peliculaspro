...
export async function generateMetadata({ params }) {
  ...
  if (CATEGORIES.includes(slug)) {
    ...
    return {
      title: `PeliculasPro - ${title} Movies`,
      description: `Explore the ${title} movies collection on PeliculasPro.`,
    };
  }
  ...
  if (genreMatch) {
    ...
    return {
      title: `PeliculasPro - ${genreName} Movies`,
      description: `Discover ${genreName} movies on PeliculasPro.`,
    };
  }
